...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/audio_policy_configuration.xml:system/vendor/etc/audio_policy_configuration.xml \
    $(LOCAL_PATH)/configs/media/audio_effects.xml:system/vendor/etc/audio_effects.xml \
